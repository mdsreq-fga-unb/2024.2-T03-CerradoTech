...
|------------|------------------------------------------------------------|--------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------|
| **FM1**    | Cadastro de Usuário                                | Revisar e otimizar o processo de cadastro do usuário, incluindo possíveis ajustes em segurança e experiência do usuário. | Melhorar a eficácia e a experiência do usuário ao realizar o cadastro, garantindo segurança aprimorada e fluidez no processo. |
| **FM2**    | Login de Usuário                                | Revisar e otimizar o processo de login do usuário, incluindo possíveis ajustes em segurança e experiência do usuário. | Melhorar a eficácia e a experiência do usuário ao realizar o login, garantindo segurança aprimorada e fluidez no processo. |
| **FM3**    | Catálogo de Espécies                                       | Atualizar as informações das espécies e melhorar a funcionalidade de busca e categorização.         | Otimizar o catálogo, assegurando que as informações estejam atualizadas e que os usuários possam realizar buscas e filtrar as espécies de forma mais eficiente. |
| **FM4**    | Minha Conta                                               | Verificar e corrigir possíveis inconsistências no gerenciamento de informações pessoais do usuário. | Garantir que o sistema de gerenciamento de contas esteja funcionando corretamente, permitindo aos usuários editar e atualizar suas informações pessoais sem erros. |
| **FM5**    | Registro de Informações do Imóvel e Produção               | Garantir que os dados sejam armazenados corretamente e que as funcionalidades de edição e exclusão funcionem conforme o esperado. | Melhorar a confiabilidade do armazenamento de informações sobre o imóvel e a produção, permitindo que os usuários registrem, editem e excluam dados sem problemas. |
| **FM6**    | Identificação de Áreas de Desmate                          | Aperfeiçoar os algoritmos de detecção e corrigir possíveis erros na geração de alertas e relatórios. | Melhorar os algoritmos utilizados para detectar áreas de desmate, aprimorando a precisão das análises e corrigindo qualquer erro nos alertas e relatórios gerados. |
